...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <![endif]-->
                <!--welcome-hero start -->
                @include('layouts.estate.header')
                 <!--welcome-hero end -->

                <!--new-arrivals start -->
                @include('layouts.estate.new')
                <!--new-arrivals end -->

                <!--new-arrivals start -->
                @include('layouts.estate.featured')
                <!--new-arrivals end -->

                <!--new-arrivals start -->
                @include('layouts.estate.rated')
                <!--new-arrivals end -->

                <!--blog start -->
                @include('layouts.estate.blog')
                <!--blog end -->

                <!--contact start -->
                @include('layouts.estate.contact')
                <!--contact end -->
               

                <!--footer start-->
                @include('layouts.estate.footer')
                <!--footer end-->
