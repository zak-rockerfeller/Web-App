...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <![endif]-->
                ...
                <!--new-arrivals start -->
                @include('layouts.services.art')
                <!--new-arrivals end -->

                <!--new-arrivals start -->
                @include('layouts.services.featured')
                <!--new-arrivals end -->

                <!--new-arrivals start -->
                @include('layouts.services.design')
                <!--new-arrivals end -->

                <!--blog start -->
                @include('layouts.services.blog')
                <!--blog end -->

                <!--contact start -->
                @include('layouts.services.contact')
                <!--contact end -->
