...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <![endif]-->
               <!--welcome-hero start -->
                @include('layouts.camping.header')
                 <!--welcome-hero end -->

                <!--new-arrivals start -->
                @include('layouts.camping.featured')
                <!--new-arrivals end -->

                <!--blog start -->
                @include('layouts.camping.blog')
                <!--blog end -->

                <!--contact start -->
                @include('layouts.camping.contact')
                <!--contact end -->
               

                <!--footer start-->
                @include('layouts.camping.footer')
                <!--footer end-->
