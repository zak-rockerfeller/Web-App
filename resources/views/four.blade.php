...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!-- title of site -->
        <title>Four Bedroom Apartments</title>
        ...
        <![endif]-->
               <!--welcome-hero start -->
                @include('layouts.four.header')
                 <!--welcome-hero end -->

                <!--new-arrivals start -->
                @include('layouts.four.featured')
                <!--new-arrivals end -->

                <!--blog start -->
                @include('layouts.four.blog')
                <!--blog end -->

                <!--contact start -->
                @include('layouts.four.contact')
                <!--contact end -->
               

                <!--footer start-->
                @include('layouts.four.footer')
                <!--footer end-->
