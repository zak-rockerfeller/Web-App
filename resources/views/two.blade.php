...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!-- title of site -->
        <title>Two Bedroom Apartments</title>
        ...
        <![endif]-->
               <!--welcome-hero start -->
                @include('layouts.two.header')
                 <!--welcome-hero end -->

                <!--new-arrivals start -->
                @include('layouts.two.featured')
                <!--new-arrivals end -->

                <!--blog start -->
                @include('layouts.two.blog')
                <!--blog end -->

                <!--contact start -->
                @include('layouts.two.contact')
                <!--contact end -->
               

                <!--footer start-->
                @include('layouts.two.footer')
                <!--footer end-->
