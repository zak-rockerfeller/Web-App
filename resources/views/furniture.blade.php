...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <![endif]-->
                <!--welcome-hero start -->
                @include('layouts.furniture.header')
                 <!--welcome-hero end -->


                <!--new-arrivals start -->
                @include('layouts.furniture.new')
                <!--new-arrivals end -->

                <!--new-arrivals start -->
                @include('layouts.furniture.featured')
                <!--new-arrivals end -->

                <!--new-arrivals start -->
                @include('layouts.furniture.rated')
                <!--new-arrivals end -->

                <!--blog start -->
                @include('layouts.furniture.blog')
                <!--blog end -->

                <!--contact start -->
                @include('layouts.furniture.contact')
                <!--contact end -->
               

                <!--footer start-->
                @include('layouts.furniture.footer')
                <!--footer end-->
