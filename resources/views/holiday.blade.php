...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <![endif]-->
               <!--welcome-hero start -->
                @include('layouts.holiday.header')
                 <!--welcome-hero end -->

                <!--new-arrivals start -->
                @include('layouts.holiday.featured')
                <!--new-arrivals end -->

                <!--blog start -->
                @include('layouts.holiday.blog')
                <!--blog end -->

                <!--contact start -->
                @include('layouts.holiday.contact')
                <!--contact end -->
               

                <!--footer start-->
                @include('layouts.holiday.footer')
                <!--footer end-->
