...
<div class="container-fluid" id="header">
	...
	<nav class="navbar navbar-expand-md navbar-light">
		<div class="container">
		  ...
		  <a class="navbar-brand" href="/blog"><img src="blog/img/logo.png"></a>
		...
		<div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo03">
		                ...
		                <ul class="navbar-nav">
		                    <li class="nav-item">
		                    <a class="nav-link" href="/blog/travel/index.html">Travel</a>
		                  </li>
		                <li class="nav-item">
		                  <a class="nav-link" href="/blog/personal/index.html">Personal</a>
		                </li>

		                <li class="nav-item">
		                  <a class="nav-link" href="/blog/tech/index.html">Tech</a>
		                </li>

		                <li class="nav-item">
		                  <a class="nav-link" href="/blog/lifestyle/index.html">Lifestyle</a>
		                </li>
		            </ul>
		  </div>
	  </div>
	  ...
	  <div class="container" id="hero">
	  	<div class="row justify-content-end">
	  		<div class="col-lg-6 hero-img-container">
	  			<a href="/whispers">
	  			<div class="hero-img">
	  				<img src="blog/img/new/tech.jpeg">
	  			</div>
	  			</a>
	  		</div>	  		
	  		...
	  		<div class="col-lg-6">
	  			<div class="hero-meta">
	  				...
	  				<div class="author">
	  					<div class="author-img"><img src="blog/img/author-img.png"></div>
...
<footer class="container-fluid mt-1 p-4">
	<div class="container ">
		<div class="row pb-1"> 
		<!-- Footer logo -->
		<div class="col-lg-3 col-md-12"><img src="blog/img/logo.png"></div>
