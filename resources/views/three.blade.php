...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!-- title of site -->
        <title>Three Bedroom Apartments</title>
        ...
        <![endif]-->
               <!--welcome-hero start -->
                @include('layouts.three.header')
                 <!--welcome-hero end -->

                <!--new-arrivals start -->
                @include('layouts.three.featured')
                <!--new-arrivals end -->

                <!--blog start -->
                @include('layouts.three.blog')
                <!--blog end -->

                <!--contact start -->
                @include('layouts.three.contact')
                <!--contact end -->
               

                <!--footer start-->
                @include('layouts.three.footer')
                <!--footer end-->
