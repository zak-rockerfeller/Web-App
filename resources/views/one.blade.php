...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!-- title of site -->
        <title>Nest One Bedroom Apartments</title>
        ...
        <![endif]-->
               <!--welcome-hero start -->
                @include('layouts.one.header')
                 <!--welcome-hero end -->

                <!--new-arrivals start -->
                @include('layouts.one.featured')
                <!--new-arrivals end -->

                <!--blog start -->
                @include('layouts.one.blog')
                <!--blog end -->

                <!--contact start -->
                @include('layouts.one.contact')
                <!--contact end -->
               

                <!--footer start-->
                @include('layouts.one.footer')
                <!--footer end-->
