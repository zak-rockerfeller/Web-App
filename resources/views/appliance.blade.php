...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <![endif]-->
                <!--welcome-hero start -->
                @include('layouts.appliance.header')
                 <!--welcome-hero end -->
      

                <!--new-arrivals start -->
                @include('layouts.appliance.featured')
                <!--new-arrivals end -->


                <!--blog start -->
                @include('layouts.appliance.blog')
                <!--blog end -->

                <!--contact start -->
                @include('layouts.appliance.contact')
                <!--contact end -->
               

                <!--footer start-->
                @include('layouts.appliance.footer')
                <!--footer end-->
