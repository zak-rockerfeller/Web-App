...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <![endif]-->
               <!--welcome-hero start -->
                @include('layouts.fitness.header')
                 <!--welcome-hero end -->

                <!--new-arrivals start -->
                @include('layouts.fitness.featured')
                <!--new-arrivals end -->

                <!--blog start -->
                @include('layouts.fitness.blog')
                <!--blog end -->

                <!--contact start -->
                @include('layouts.fitness.contact')
                <!--contact end -->
               

                <!--footer start-->
                @include('layouts.fitness.footer')
                <!--footer end-->
